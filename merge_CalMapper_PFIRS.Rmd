...
### Method 1, with added black bar
```{r}
add_on <- data.frame(Year = "2020, US EPA", source = "HMS", ac = 79617)
...
plot
# Adjust the width of the plot using theme() and plot.margin
plot2 <- plot +
  theme(
    plot.margin = margin(-1, 1, 1, 3, unit = "cm")  # Adjust the right margin (3 cm in this case)
  )+
  ggtitle("plot with adjusted margins")
